/* 1 STORY MAKER — Online Runtime Bootstrap v10
 * Stable public entrypoint. Runtime base + v5 + v6 + v7 + v8 + v9 + v10 patches are pinned.
...
const STORY_MAKER_V10_PATCH_COMMIT='36fe4727e8a389b061169f077b6dac65f7b9c4de';
...
const STORY_MAKER_V10_PATCH10='https://raw.githubusercontent.com/mindslash79/allstorymap/'+STORY_MAKER_V10_PATCH_COMMIT+'/story-maker/StoryMaker.patch.v10.gs';
...
function smRunAction_(action){
  ...
  const p10=UrlFetchApp.fetch(STORY_MAKER_V10_PATCH10,{muteHttpExceptions:true});
  ...
  if(p10.getResponseCode()!==200)throw new Error('Story Maker v10 patch10 HTTP '+p10.getResponseCode());
